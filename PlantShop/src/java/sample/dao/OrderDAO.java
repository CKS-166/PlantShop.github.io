...
public class OrderDAO {
        ...
        try{
            ...
            if(cn!=null && email!=null){
                String sql = "select OrderID, OrdDate, shipdate, o.status as 'status', o.AccID as 'accID'\n"
                        + "from dbo.Orders o left join dbo.Accounts a on o.AccID = a.accid\n"
                        + "where a.email = ?";
            ...
            if(cn!=null && orderID!=0){
                ...
                if(rs!=null){
                    while(rs.next()){
                        ...
                        OrderDetail orderD = new OrderDetail(detailID, orderID, price, PlantName, price, imgPath, quantity);
                        list.add(orderD);
                    }
                }
            }
    ...
    public static int updateOrderStatus(int orderID, int newStatus) throws Exception {
        int result = 0;
        Connection cn = null;
        cn = DBUtils.makeConnection();
        if (cn != null) {
